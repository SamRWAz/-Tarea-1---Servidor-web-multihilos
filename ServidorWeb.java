...
public final class ServidorWeb {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        ServerSocket socketEscucha = new ServerSocket(puerto); // Aquí se crea el ServerSocket
        ...
        while (true) {
            ...
            Socket conexion = socketEscucha.accept(); // Aquí se acepta la conexión
            ...
            SolicitudHttp solicitud = new SolicitudHttp(conexion); // Se pasa el socket al constructor
...
final class SolicitudHttp implements Runnable {
    ...
    private void proceseSolicitud() throws Exception {
        ...
        DataOutputStream os = new DataOutputStream(socket.getOutputStream()); // Se obtiene el OutputStream

        // Referencia y filtros (InputStreamReader y BufferedReader)para el stream de entrada.
        BufferedReader br = new BufferedReader(new InputStreamReader(socket.getInputStream())); // Se obtienen el InputStream y se envuelve en los filtros

        // Recoge la línea de solicitud HTTP del mensaje.
        String lineaDeSolicitud = br.readLine(); // Se lee la línea de solicitud
